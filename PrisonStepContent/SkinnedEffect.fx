...
float3 Light1Color = float3(0.1f, 0.1f, 0.3f);
float3 Light2Location = float3(568, 246, 1036);
float3 Light2Color = float3(1, 1, 1);
float3 Light3Location = float3(568, 246, 1036);
float3 Light3Color = float3(1, 1, 1);
float3 Light4Location = float3(568, 246, 1036);
float3 Light4Color = float3(0.1f, 0.1f, 0.1f);
