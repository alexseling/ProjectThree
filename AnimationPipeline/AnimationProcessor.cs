...
namespace AnimationPipeline
{
    ...
    public class AnimationProcessor : ModelProcessor
    {
            ...
            foreach (KeyValuePair<string, AnimationContent> animation in input.Animations)
            {
                ...
                foreach (KeyValuePair<string, AnimationChannel> channel in animation.Value.Channels)
                {
                    ...
                    foreach (AnimationKeyframe keyframe in channel.Value)
                    {
                        ...
                        System.Diagnostics.Trace.WriteLine(input.Name + ": time=" + newKeyframe.Time + ", translate=(" + transform.Translation.X + "," + transform.Translation.Y + "," + transform.Translation.Z + "), rotation = (" + newKeyframe.Rotation.X + "," + newKeyframe.Rotation.Y + "," + newKeyframe.Rotation.Z + "," + newKeyframe.Rotation.W + ")");
                                                         ...
                                                         ContentProcessorContext context)
        {
            ...
            processorParameters.Add("RoomLit", roomLit);
